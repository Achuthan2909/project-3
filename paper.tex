...
\section{Experimental Setup}\index{Experimental Setup}
...
\newpage
\section{L4.1: Recognizes and Responds to Emotional Cues}\index{L4.1!Emotional Cues}
...
\newpage
\section{L4.2: Empathy Quality}\index{L4.2!Empathy Quality}
...
\newpage
\section{L4.3: De-escalation}\index{L4.3!De-escalation}
...
\newpage
\section{L4.4: Sentiment Change Across Multi Turn Sessions}\index{L4.4!Sentiment Change}
...
\newpage
\section{L4.5: Avoids Dismissiveness and Toxic Positivity}\index{L4.5!Toxic Positivity}
...
\newpage
\section{L4.6: Dismissiveness Occurrences per 1k Interactions}\index{L4.6!Dismissiveness}
...
\newpage
\section{L4.7: Users Rate the AI as Helpful in Hardship Scenarios}\index{L4.7!Helpfulness}
...
\section{Validity and Reliability}\index{Validity}\index{Reliability}
...
\section{Ethical Considerations}\index{Ethical Considerations}
...
\section{Reproducibility Guide}\index{Reproducibility}

All code, data, and documentation are available in the project repository at \texttt{https://github.com/Achuthan2909/project-3}. To replicate: install dependencies, download EmpatheticDialogues dataset, set up Ollama with Mistral 7B Instruct and Llama 2 7b chat models. Prompt sets are in \texttt{data/prompts/}. Key scripts: \texttt{scripts/generate\_responses.py}, \texttt{scripts/evaluate\_all\_indicators.py}, \texttt{model\_comparative\_analysis.ipynb}. Model parameters: temperature 0.7, max tokens 256.

\section{Appendix}\index{Appendix}

Complete prompt sets, evaluation rubrics, and statistical outputs are available in the project repository. All code, data, documentation, and replication materials are publicly available at: \texttt{https://github.com/Achuthan2909/project-3}.

The repository includes:
\begin{itemize}
\item Full prompt sets with metadata: \texttt{data/prompts/} (see \texttt{https://github.com/Achuthan2909/project-3/tree/main/data/prompts})
\item Detailed scoring rubrics for all seven indicators: \texttt{documentation/phase1.md} (see \texttt{https://github.com/Achuthan2909/project-3/blob/main/documentation/phase1.md})
\item Complete evaluation results with justifications: \texttt{data/model\_outputs/} (see \texttt{https://github.com/Achuthan2909/project-3/tree/main/data/model\_outputs})
\item Statistical analysis outputs including correlation matrices: \texttt{model\_comparative\_analysis.ipynb} (see \texttt{https://github.com/Achuthan2909/project-3/blob/main/model\_comparative\_analysis.ipynb})
...
\item All scripts for replication: \texttt{scripts/} (see \texttt{https://github.com/Achuthan2909/project-3/tree/main/scripts})
\end{itemize}

For detailed methodological information, see:
\begin{itemize}
\item \texttt{documentation/phase1.md} - Complete scoring rubrics (see \texttt{https://github.com/Achuthan2909/project-3/blob/main/documentation/phase1.md})
\item \texttt{documentation/phase2\_implementation\_plan.md} - Data collection methodology (see \texttt{https://github.com/Achuthan2909/project-3/blob/main/documentation/phase2\_implementation\_plan.md})
\item \texttt{documentation/validity\_analysis\_report.md} - Validity evidence (see \texttt{https://github.com/Achuthan2909/project-3/blob/main/documentation/validity\_analysis\_report.md})
\end{itemize}
